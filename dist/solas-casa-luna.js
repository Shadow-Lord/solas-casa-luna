...
class CasaLuna extends HTMLElement {
  ...
  static getStubConfig() {
    return {
      pv1_power: 'sensor.solis_inverter_103_solis_dc_power_pv1',
      pv2_power: 'sensor.solis_inverter_103_solis_dc_power_pv2',
      pv3_power: '',
      pv4_power: '',
      pv5_power: '',
      pv6_power: '',
      pv_total_power: 'sensor.solis_inverter_103_solis_ac_output_total_power',
      grid_active_power: 'sensor.solis_inverter_103_solis_grid_phase1_power',
      grid_export_energy: 'sensor.solis_inverter_103_solis_daily_on_grid_energy',
      consump: 'sensor.solis_inverter_103_solis_total_consumption_power',
      today_pv: 'sensor.solis_inverter_103_solis_energy_today',
      total_pv: 'sensor.solis_inverter_103_solis_energy_total',
      total_import: 'sensor.solis_inverter_103_solis_total_energy_purchased',
      total_export: 'sensor.solis_inverter_103_solis_total_on_grid_energy',
      inverter_state: 'sensor.solis_inverter_103_solis_power_state',
      inverter_error: '',
      ...
      battery_cap_unit: 'kwh',
      battery2_cap_unit: 'kwh',
      battery2_full_ah: '0',
      battery2_full_wh: '0',
      ...
      sun: 'sun.sun',
      weather_entity: 'sensor.openweathermap_weather',
      weather_temp_entity: 'sensor.openweathermap_apparent_temperature',
      weather_wind_entity: 'sensor.openweathermap_wind_speed',
      weather_dir_entity: 'sensor.openweathermap_wind_direction',
      inverter_name: 'Solas 5',
      label_bms_temp: 'BMS TEMP',
      label_endurance: 'ENDURANCE',
      label_batt_current: 'BATT CURRENT',
      label_capacity: 'CAPACITY',
      pv1_voltage: 'sensor.solis_inverter_103_solis_dc_voltage_pv1',
      pv2_voltage: 'sensor.solis_inverter_103_solis_dc_voltage_pv2',
      pv3_voltage: '',
      pv4_voltage: '',
      pv5_voltage: '',
      pv6_voltage: '',
      grid_import_today: 'sensor.solis_inverter_103_solis_daily_grid_energy_purchased',
      grid_voltage: 'sensor.solis_inverter_103_solis_ac_voltage_r',
      _show_phase: 'true',
      grid_phase_a: 'sensor.solis_inverter_103_solis_power_grid_total_power',
      grid_phase_b: '',
      grid_phase_c: '',
      grid_phase_a_volt: 'sensor.solis_inverter_103_solis_meter_item_a_volt',
      grid_phase_b_volt: '',
      grid_phase_c_volt: '',
      ...
      auto_discover_security: 'false',
      auto_discover_climate: 'false',
      auto_discover_lighting: 'false',
      auto_discover_automation: 'false',
      events_entities: [],
      /* ── phase / inverter flip tile ── */
      label_phase_title: 'GRID PHASES', label_inv_title: 'INVERTER',
      inv_l1_power: 'sensor.solis_inverter_103_solis_ac_output_total_power',
      inv_l2_power: '',
      inv_l3_power: '',
      inverter_output_power: '',
      inv_l1_volt: 'sensor.solis_inverter_103_solis_ac_voltage_r',
      inv_l2_volt: '',
      inv_l3_volt: '',
      ...
      clim_extra_1_entity: 'sensor.vvm_320_r_outdoor_temperature',
      clim_extra_1_name: 'Outdoor Temperature',
      clim_extra_2_entity: 'sensor.vvm_320_r_temperature',
      clim_extra_2_name: 'Indoor Temperature',
      clim_extra_3_entity: 'sensor.vvm_320_r_hot_water_temp',
      clim_extra_3_name: 'Hot Water Temperature',
      clim_extra_4_entity: '',
      clim_extra_4_name: '',
      clim_extra_5_entity: '',
      clim_extra_5_name: '',
      ...
      en_pv1: 'sensor.solis_inverter_103_solis_dc_power_pv1',
      en_pv2: 'sensor.solis_inverter_103_solis_dc_power_pv2',
      en_grid_power: '',
      en_load: '',
      en_backup: '',
      en_work_mode: '',
      ...
      sys_inv_temp: 'sensor.solis_inverter_103_solis_temperature',
      sys_work_mode: '',
      sys_c3_status: '',
      ...
      _demo_mode: false,
      calendar_entities: [],
      sys_cpu: 'sensor.system_monitor_processor_use',
      sys_memory: 'sensor.system_monitor_memory_usage',
      sys_disk: 'sensor.system_monitor_disk_usage',
      sys_uptime: 'sensor.uptime',
