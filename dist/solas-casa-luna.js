...
c.inverter_state_display_label = invDisplay.label;
c.inverter_state_display_color = invDisplay.color;
c.inverter_state_display_raw = invDisplay.raw;

console.debug('[CasaLuna] invDisplay', {
  entity_config: c.inverter_state_display_label
});
...
<div style="position:absolute;left:16px;right:14px;top:76px;display:flex;align-items:center;justify-content:space-between;gap:4px">
  ...
  <span class="val" id="invState" data-entity="${c.inverter_state || ''}" style="font-size:${Number(c.sz_invstate) || 13}px;font-weight:650;color:${c.inverter_state_display_color || '#39d353'};text-align:right;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${c.inverter_state_display_label || '--'}</span>
</div>
