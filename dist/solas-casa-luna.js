  ...
  _build() {
    ...
    <div class="box" id="battFlip" style="left:${sx0}px;top:${sy0}px;width:${sw0}px;height:${sh0}px;${c._show_battstats ? "" : "display:none"}">
      ...
      <div id="battFaceFront" style="position:absolute;inset:0">
        ...
        <div class="val" style="position:absolute;left:16px;top:10px;font-size:15px;letter-spacing:.05em">BATTERY</div>
        ${statRows}
      </div>
...
const runPricing = async () => {
    ...
    for (let i = 1; i < expHistRaw.length; i++) {
        ...
        // Solis export sometimes resets or drops backwards
        if (delta < 0) continue;
...
class CasaLunaEditor extends HTMLElement {
  ...
  _render() {
    ...
    shell.appendChild(section('inverter', '🔄', 'Inverter Status', [
      eg('inverter_time', 'INVERTER TIME'),
